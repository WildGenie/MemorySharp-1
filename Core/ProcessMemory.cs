...
using System.Text;
using Binarysharp.MemoryManagement.Core.Shared.Patterns;
using Binarysharp.MemoryManagement.Helpers;
using Binarysharp.MemoryManagement.MemoryExtensions;

namespace Binarysharp.MemoryManagement.Core.Shared
{
    /// <summary>
    ...
    public abstract class ProcessMemory : IDisposable
    {
        ...
        /// <summary>
        ///     Creates a <see cref="ModulePatternFactory" /> Instance for the given process module.
        /// </summary>
        /// <param name="processModule">The process module.</param>
        /// <returns>A new <see cref="ModulePatternFactory" /> Instance.</returns>
        public ModulePatternFactory CreatePatternScanner(ProcessModule processModule)
        {
            return new ModulePatternFactory(Process, processModule);
        }
