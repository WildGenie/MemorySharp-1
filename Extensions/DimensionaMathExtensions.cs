using System;
using Binarysharp.MemoryManagement.Math3D;
...
namespace Binarysharp.MemoryManagement.Extensions
{
    ...
    public static class DimensionaMathExtensions
    {
        ...
        public static bool PointInCircle(this Vector2 point, Vector2 circleCenter, float radius)
            => (point - circleCenter).Length() < radius;
        ...
        public static float RadiansToDegrees(float rad) => rad*Rad2Deg;
