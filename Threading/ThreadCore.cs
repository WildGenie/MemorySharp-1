...
namespace Binarysharp.MemoryManagement.Threading
{
    ...
    public static class ThreadCore
    {
            ...
            IntPtr parameter, ThreadCreationFlags creationFlags = ThreadCreationFlags.Run)
        {
            ...
            int threadId;
            var ret = SafeNativeMethods.CreateRemoteThread(processHandle, IntPtr.Zero, 0, startAddress, parameter,
        ...
        public static ThreadBasicInformation NtQueryInformationThread(SafeMemoryHandle threadHandle)
        {
            ...
            var ret = SafeNativeMethods.NtQueryInformationThread(threadHandle, 0, ref info,
                SafeMarshalType<ThreadBasicInformation>.Size, IntPtr.Zero);
