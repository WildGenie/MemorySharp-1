...
namespace ToolsSharp.Hooks.WndProc
{
    /// <summary>
    ...
    public class WindowHook : INamedElement
    {
        ...
        /// <summary>
        ///     Gets the <see cref="IWindowEngine" /> instance for this hook. The engines <code>StartUp()</code> and
        ///     <code>ShutDown()</code> methods are used when the corresponding user messages are invoked.
        /// </summary>
