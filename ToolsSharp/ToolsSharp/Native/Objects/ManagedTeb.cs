...
namespace ToolsSharp.Native.Objects
{
    ...
    public class ManagedTeb : ProxyPointer
    {
        ...
        /// </summary>
        /// <param name="process">The process tghe teb is located inside of.</param>
        ...
        {
            get { return ReadArray<byte>(TebStructure.Win32ClientInfo, 124); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.SystemReserved1, 216); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.ActivationContextStack, 18); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.SpareBytes, 26); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.SystemReserved2, 40); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.GdiTebBatch, 1248); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.UserReserved1, 20); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.GlReserved1, 1248); }
        ...
        {
            get { return ReadArray<byte>(TebStructure.StaticUnicodeString, 532); }
        ...
        {
            get { return ReadArray<IntPtr>(TebStructure.TlsSlots, 64); }
