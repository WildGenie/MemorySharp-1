...
namespace ToolsSharp.Native.Enums
{
    /// <summary>
    ...
    public enum WindowsMessages : uint
    {
        ...
        ///     but does not have an icon defined for its class. An application can return a processHandle to an icon or cursor.
        ///     The
        ...
        ///     activities. The message is posted with a NULL window processHandle.
        /// </summary>
        ...
        /// <summary>
        ///     The WM_GETICON message is sent to a window to retrieve a processHandle to the large or small icon associated with a
        ...
        ///     WM_CHAR uses UTF-16. It is designed to send or post Unicode characters to ANSI windows and it can can processHandle
        ...
        ///     given display device context processHandle.
        /// </summary>
        ...
        ///     processHandle to set the text and background colors of the edit control.
        /// </summary>
        CtlColorEdit = 0x0133,
        ...
        ///     message, the dialog box can set its text and background colors using the specified display device context
        ///     processHandle.
        /// </summary>
        CtlColorDlg = 0x0136,
        ...
        ///     be drawn. By responding to this message, the parent window can use the display context processHandle to set the
        ///     background
        ...
        ///     specified device context processHandle to set the text and background colors of the static control.
        /// </summary>
        ...
        ///     the processHandle to the active MDI child window.
        /// </summary>
        MdiGetActive = 0x0229,
