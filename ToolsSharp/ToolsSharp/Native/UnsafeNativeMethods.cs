...
namespace ToolsSharp.Native
{
    ...
    public static class UnsafeNativeMethods
    {
        ...
        [DllImport("ntdll.dll")]
        public static extern int NtQueryInformationProcess(IntPtr processHandle, ProcessInformationClass infoclass,
        ...
        /// <returns>Returns an NTSTATUS success or error code. (STATUS_SUCCESS = 0x0).</returns>
        [DllImport("ntdll.dll")]
        public static extern uint NtQueryInformationThread(IntPtr hwnd, uint infoclass,
        ...
        /// </summary>
        /// <param name="hWnd">
        ///     A processHandle to the window whose window procedure will receive the message. If this parameter is
        ...
        /// </param>
        /// <param name="hWnd">A processHandle to the window procedure to receive the message.</param>
