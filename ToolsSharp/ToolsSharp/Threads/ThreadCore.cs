...
namespace ToolsSharp.Threads
{
    ...
    public static class ThreadCore
    {
        ...
        /// </summary>
        /// <param name="processHandle">A processHandle to the process in which the thread is to be created.</param>
        /// <param name="handle">The safe memory handle instance of the process.</param>
        ...
        /// <returns>A processHandle to the new thread.</returns>
        public static SafeMemoryHandle CreateRemoteThread(SafeMemoryHandle handle, IntPtr startAddress,
                                                          IntPtr parameter,
                                                          ThreadCreationFlags creationFlags = ThreadCreationFlags.Run)
        {
            ...
            int threadId;
            var ret = SafeNativeMethods.CreateRemoteThread(handle, IntPtr.Zero, 0, startAddress, parameter,
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread.</param>
        /// <returns>
        ...
        public static IntPtr? GetExitCodeThread(SafeMemoryHandle threadHandle)
        {
            ...
            if (!SafeNativeMethods.GetExitCodeThread(threadHandle, out exitCode))
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread whose context is to be retrieved.</param>
                                                     ...
                                                     ThreadContextFlags contextFlags = ThreadContextFlags.Full)
        {
            ...
            if (SafeNativeMethods.GetThreadContext(threadHandle, ref context))
                return context;
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread containing the specified selector.</param>
        ...
        public static LdtEntry GetThreadSelectorEntry(SafeMemoryHandle threadHandle, uint selector)
        {
            ...
            LdtEntry entry;
            if (SafeNativeMethods.GetThreadSelectorEntry(threadHandle, selector, out entry))
                return entry;
        ...
        /// <returns>An open processHandle to the specified thread.</returns>
        public static SafeMemoryHandle OpenThread(ThreadAccessFlags accessFlags, int threadId)
        {
            // Open the thread
            var ret = SafeNativeMethods.OpenThread(accessFlags, false, threadId);
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread to query.</param>
        ...
        public static ThreadBasicInformation NtQueryInformationThread(SafeMemoryHandle threadHandle)
        {
            ...
            // Get the thread info
            var ret = SafeNativeMethods.NtQueryInformationThread(threadHandle, 0, ref info,
                SafeMarshal<ThreadBasicInformation>.Size, IntPtr.Zero);
        ...
        ///     resumed.
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread to be restarted.</param>
        ...
        public static uint ResumeThread(SafeMemoryHandle threadHandle)
        {
            ...
            // Resume the thread
            var ret = SafeNativeMethods.ResumeThread(threadHandle);
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread whose context is to be set.</param>
        /// <param name="context">
        ...
        public static void SetThreadContext(SafeMemoryHandle threadHandle, ThreadContext context)
        {
            ...
            if (!SafeNativeMethods.SetThreadContext(threadHandle, ref context))
        ...
        /// </summary>
        /// <param name="threadHandle">A processHandle to the thread that is to be suspended.</param>
        /// <returns>The thread's previous suspend count.</returns>
        public static uint SuspendThread(SafeMemoryHandle threadHandle)
        {
            ...
            // Suspend the thread
            var ret = SafeNativeMethods.SuspendThread(threadHandle);
        ...
        public static void TerminateThread(SafeMemoryHandle threadHandle, int exitCode)
        {
            ...
            var ret = SafeNativeMethods.TerminateThread(threadHandle, exitCode);
        ...
        /// </summary>
        /// <param name="handle">A processHandle to the object.</param>
        /// <param name="timeout">
        ...
        public static WaitValues WaitForSingleObject(SafeMemoryHandle handle, TimeSpan? timeout)
        {
            ...
            var ret = SafeNativeMethods.WaitForSingleObject(handle,
        ...
        public static WaitValues WaitForSingleObject(SafeMemoryHandle handle)
        {
            ...
            // Wait for single object
            var ret = SafeNativeMethods.WaitForSingleObject(handle, 0xFFFFFFFF);
