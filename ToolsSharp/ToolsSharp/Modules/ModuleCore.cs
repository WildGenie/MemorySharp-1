...
namespace ToolsSharp.Modules
{
    ...
    public static class ModuleCore
    {
        ...
        public static IntPtr GetProcAddress(string moduleName, string functionName)
        {
            ...
            var module =
                Process.GetCurrentProcess()
                       ...
                       .FirstOrDefault(
                           m => string.Equals(m.ModuleName, moduleName, StringComparison.CurrentCultureIgnoreCase));
            ...
            var ret = SafeNativeMethods.GetProcAddress(module.BaseAddress, functionName);
        ...
        public static void FreeLibrary(string libraryName)
        {
            ...
            // Free the library
            if (!SafeNativeMethods.FreeLibrary(module.BaseAddress))
        ...
        public static ProcessModule LoadLibrary(string libraryPath)
        {
            ...
            if (SafeNativeMethods.LoadLibrary(libraryPath) == IntPtr.Zero)
