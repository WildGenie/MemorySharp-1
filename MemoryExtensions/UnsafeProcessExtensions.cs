...
namespace Binarysharp.MemoryManagement.MemoryExtensions
{
    /// <summary>
    ...
    ///     </remarks>
    /// </summary>
    public static class UnsafeProcessExtensions
    {
        /// <summary>
        ...
        {
            return RemoteMemoryCore.ReadProcessMemory(process.Handle, address, size);
        }
        ...
        {
            return RemoteMemoryCore.Read<T>(process.Handle, address);
        }
        ...
        {
            return RemoteMemoryCore.ReadArray<T>(proc.Handle, address, count);
        }
        ...
        {
            // Read the string
            var data = encoding.GetString(RemoteMemoryCore.ReadProcessMemory(process.Handle, address, maxLength));
        ...
        {
            return RemoteMemoryCore.WriteProcessMemory(process.Handle, address, byteArray);
        }
        ...
        {
            RemoteMemoryCore.Write(process.Handle, address, value);
        }
        ...
        {
            RemoteMemoryCore.WriteArray(process.Handle, address, dataArray);
        }
        ...
        {
            RemoteMemoryCore.WriteProcessMemory(process.Handle, address, encoding.GetBytes(text + '\0'));
        }
        ...
        /// <summary>
        ///     Opens the specified process and returns the handle.
        /// </summary>
        /// <param name="process">The process.</param>
        ...
        {
            return RemoteMemoryCore.OpenProcess(processAccessFlags, process.Id);
        }
        ...
        {
            return RemoteMemoryCore.Allocate(process.Handle, size, protectionFlags, allocationFlags);
        }
        ...
        {
            RemoteMemoryCore.Free(process.Handle, address);
        }
        ...
        {
            return RemoteMemoryCore.NtQueryInformationProcess(process.Handle);
        }
        ...
        {
            return RemoteMemoryCore.ChangeProtection(process.Handle, address, size, protection);
        }
        ...
        {
            return RemoteMemoryCore.Query(process.Handle, baseAddress);
        }
        ...
        public static IEnumerable<MemoryBasicInformation> Query(this Process process, IntPtr addressFrom,
            IntPtr addressTo)
        {
            return RemoteMemoryCore.Query(process.Handle, addressFrom, addressTo);
        }
    }
}