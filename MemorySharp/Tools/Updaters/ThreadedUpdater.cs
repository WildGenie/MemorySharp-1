...
namespace Binarysharp.MemoryManagement.Tools.Updaters
{
    ...
    public class ThreadedUpdater : INamedElement
    {
        ...
        // These properties are needed for the class to function, however are not needed for the end-user to interact with and should remain private.
        ...
        /// <summary>
        ///     Gets the total run time since the updater was started as a
        ///     <code>new TimeSpan(DateTime.Now.Ticks - BeginTime);</code> instance.
        /// </summary>
