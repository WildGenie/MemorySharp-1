...
namespace Binarysharp.MemoryManagement.Common.Updaters
{
    ...
    public class TimedUpdater<T>
    {
        ...
        /// </summary>
        /// <param name="stateObject">The stateObject.</param>
        protected virtual void Process(object stateObject)
        {
            OnUpdate?.Invoke(this, (T) stateObject);
        }
    }
}