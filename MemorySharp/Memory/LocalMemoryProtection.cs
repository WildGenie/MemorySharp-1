...
namespace Binarysharp.MemoryManagement.Memory
{
    ...
    /// </summary>
    public class LocalMemoryProtection : IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="Binarysharp.MemoryManagement.Memory.MemoryProtection" /> class.
        /// </summary>
        ...
        public LocalMemoryProtection(IntPtr handle, IntPtr baseAddress, int size,
        ...
        /// <summary>
        ///     States if the <see cref="Binarysharp.MemoryManagement.Memory.MemoryProtection" /> object nust be disposed when it
        ///     is collected.
        /// </summary>
