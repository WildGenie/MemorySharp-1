...
namespace Binarysharp.MemoryManagement.LocalProcess.Extensions
{
    /// <summary>
    ///     Class containing extension methods releated to <see cref="uint" /> values.
    ///     <remarks>
    ///         This classes Read/Write methods are intended to be used for local reading and writing memory, aka
    ///         "injected" or "internal".
    ///     </remarks>
    /// </summary>
    public static class UnsafeUIntExtensions
    {
        /// <summary>
        ...
        public static T Read<T>(this uint address, bool isRelative) where T : struct
        {
        ...
        public static T[] ReadArray<T>(this uint address, int count, bool isRelative) where T : struct
        {
        ...
        /// </exception>
        public static string ReadString(this uint address, Encoding encoding, int maximumLength = 512,
        ...
        /// <returns>System.IntPtr.</returns>
        public static void Write<T>(this uint address, T value) where T : struct
        {
        ...
        public static void WriteArray<T>(this uint address, T[] arrayOfValues) where T : struct
        {
        ...
        public static void WriteString(this uint address, string text, Encoding encoding)
        {
        ...
        /// <returns>System.IntPtr.</returns>
        public static IntPtr GetVTablePointer(this uint address, int index)
        {
