...
namespace Binarysharp.MemoryManagement.Patterns
{
    ...
    public class Pattern
    {
        ...
        public string Mask => PatternScanHelper.GetMaskFromDwordPattern(TextPattern);

        /// <summary>
        ///     Gets the <code>byte[]</code> pattern from text pattern in this instance.
        /// </summary>
        /// <returns>An array of bytes.</returns>
        public byte[] PatternBytes => PatternScanHelper.GetBytesFromDwordPattern(TextPattern);
        #endregion

        /// <summary>
        ///     Gets the pattern scanner instance.
        /// </summary>
        /// <param name="process">The process the module to scan is located in.</param>
        /// <param name="module">The process module the data to scan is contained in.</param>
        /// <returns>Binarysharp.MemoryManagement.Patterns.ProcessModulePatternScanner.</returns>
        public ProcessModulePatternScanner GetPatternScanner(Process process, ProcessModule module)
            => new ProcessModulePatternScanner(process, module);
    }
}