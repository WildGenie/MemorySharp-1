...
namespace Binarysharp.MemoryManagement.Native
{
    ...
    public abstract class NativeDriverBase
    {
        ...
        /// </summary>
        private static readonly Lazy<NativeDriverBase> _defaultDriver =
            new Lazy<NativeDriverBase>(GetDefaultNativeDriver);
        #endregion
        ...
        public static NativeDriverBase Default => _defaultDriver.Value;
