...
namespace Binarysharp.MemoryManagement.Marshaling
{
    ...
    public static class MarshalType<T>
    {
        ...
        static MarshalType()
        {
            ...
            CanBeStoredInRegisters = IntPtr.Size == 4
                ? CheckIfCanBeStoredInRegisters32()
                : CheckIfCanBeStoredInRegisters64();
        }
        #endregion
        ...
        /// </summary>
        public static bool IsIntPtr { private get; set; }
        ...
        private static bool CheckIfCanBeStoredInRegisters32()
        {
            return IsIntPtr ||
        ...
        private static bool CheckIfCanBeStoredInRegisters64()
        {
            return CheckIfCanBeStoredInRegisters32() ||
                TypeCode == TypeCode.Int64 ||
