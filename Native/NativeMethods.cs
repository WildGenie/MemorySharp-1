...
namespace MemorySharp.Native
{
    ...
    public static class NativeMethods
    {
        ...
        ///     <see cref="IntPtr.Zero" />, the thread identifier is not returned.
        /// </param>
        /// <returns>
        ///     If the function succeeds, the return value is a handle to the new thread. If the function fails, the return
        ///     value is <see cref="IntPtr.Zero" />. Call <see cref="Marshal.GetLastWin32Error" /> to get Win32 Error.
        /// </returns>
        ...
        /// </summary>
        /// <param name="hProcess">
        ///     Handle to the process to write memory to.
        ///     The handle must have <see cref="ProcessAccessFlags.VMWrite" /> and <see cref="ProcessAccessFlags.VMOperation" />
        ///     access to the process
        /// </param>
