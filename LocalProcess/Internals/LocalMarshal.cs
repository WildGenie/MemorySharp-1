...
namespace Binarysharp.MemoryManagement.LocalProcess.Internals
{
    /// <summary>
    ...
    public static class LocalMarshal<T>
    {
        ...
        /// <summary>
        ///     Initializes static members of the <see cref="LocalMarshal{T}" /> class.
        /// </summary>
        static LocalMarshal()
        {
            ...
            Debug.Write("[RemoteMarshal] " + typeof (T) + " Size: " + SizeU);
            ...
            var method = new DynamicMethod($"GetPinnedPtr<{typeof (T).FullName.Replace(".", "<>")}>",
                typeof (void*), new[] {typeof (T).MakeByRefType()}, typeof (LocalMarshal<>).Module);
