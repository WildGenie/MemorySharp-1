...
{
    /// <summary>
    ///     Class containing extension methods releated to <see cref="int" /> values.
    /// </summary>
    public static class UnsafeIntegerExtensions
    {
        /// <summary>
        ...
        public static T Read<T>(this int address, bool isRelative) where T : struct
        {
        ...
        public static T[] ReadArray<T>(this int address, int count, bool isRelative) where T : struct
        {
        ...
        /// </exception>
        public static string ReadString(this int address, Encoding encoding, int maximumLength = 512,
        ...
        /// <returns>System.IntPtr.</returns>
        public static void Write<T>(this int address, T value) where T : struct
        {
        ...
        public static void WriteArray<T>(this int address, T[] arrayOfValues) where T : struct
        {
        ...
        /// <param name="isRelative">[Optional] State if the address is relative to the main module.</param>
        public static void WriteString(this int address, string text, Encoding encoding)
        {
        ...
        /// <returns>System.IntPtr.</returns>
        public static IntPtr GetVTablePointer(this int address, int index)
        {
