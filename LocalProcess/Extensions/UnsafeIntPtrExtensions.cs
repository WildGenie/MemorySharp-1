...
namespace Binarysharp.MemoryManagement.LocalProcess.Extensions
{
    ...
    public static class UnsafeIntPtrExtensions
    {
        ...
        {
            return LocalMemoryCore.ReadString(address, encoding, maximumLength, isRelative);
        }
        ...
        {
            LocalMemoryCore.WriteString(address, text, encoding, isRelative);
        }
        ...
        public static VirtualClass ToVirtualClass(this IntPtr address)
        {
            return LocalMemoryCore.CreateVirtualClass(address);
        }
        ...
        public static ProcessFunction<T> ToProcessFunction<T>(this IntPtr address, string name)
        {
            return LocalMemoryCore.CreateProcessFunction<T>(address, name);
        }
        ...
        {
            return LocalMemoryCore.RegisterDelegate<T>(address);
        }
    }
}